...
#
#  $ bin/test -s uvc.schriften -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src uvc.schriften.testing.UVC_SCHRIFTEN_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/uvc/schriften/tests/robot/test_example.robot
#
